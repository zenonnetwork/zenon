...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/eastcoastcrypto/Zenon-detached-sigs.git
...
### Build and sign Zenon Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit Zenon=v${VERSION} ../Zenon/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [Zenon-detached-sigs](https://github.com/eastcoastcrypto/Zenon-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the Zenoncoin.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/eastcoastcrypto/Zenon/releases/new) with a link to the archived release notes.
