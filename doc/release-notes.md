...
Zenon Core version *version* is now available from:
  ...
  <https://github.com/eastcoastcrypto/Zenon/releases>

Please report bugs using the issue tracker at github:

  <https://github.com/eastcoastcrypto/Zenonita/issues>
...
Zenon Core is extensively tested on multiple operating systems using
...
Zenon Core should also work on most other Unix-like systems but is not
