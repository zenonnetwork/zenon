...
In order to support loading of multiple wallets in Zenon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Zenon.cpp.
...
Changes to Zenon.cpp
----------------------
Zenon.cpp is the entry point into Zenon-qt, and as such, will require some minor modifications to provide hooks for
