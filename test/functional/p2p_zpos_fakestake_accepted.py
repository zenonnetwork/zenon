...
from fake_stake.base_test import ZNN_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(ZNN_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zznnstake']] * self.num_nodes
