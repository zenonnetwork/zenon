Contributing to Zenon Core
============================

The Zenon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zenon Core project, and is not to be
confused with overall Zenon Network Protocol consensus changes.

Whether a pull request is merged into Zenon Core rests with the project merge
...
Patches that change Zenon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zenon consensus, it must have been
...
The project leader is the release manager for each Zenon Core release.
