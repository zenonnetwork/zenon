...
// Zenon: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_14_NEW_VOTING_ENFORCEMENT) r = SPORK_14_NEW_VOTING_ENFORCEMENT_DEFAULT;
		...
		if (nSporkID == SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4) r = SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4_DEFAULT;
        if (nSporkID == SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5) r = SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5_DEFAULT;
        if (nSporkID == SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6) r = SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_14_NEW_VOTING_ENFORCEMENT") return SPORK_14_NEW_VOTING_ENFORCEMENT;
	...
	if (strName == "SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4") return SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4;
    if (strName == "SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5") return SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5;
    if (strName == "SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6") return SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_14_NEW_VOTING_ENFORCEMENT) return "SPORK_14_NEW_VOTING_ENFORCEMENT";
	...
	if (id == SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4) return "SPORK_22_NEW_PROTOCOL_ENFORCEMENT_4";
    if (id == SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5) return "SPORK_23_NEW_PROTOCOL_ENFORCEMENT_5";
    if (id == SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6) return "SPORK_24_NEW_PROTOCOL_ENFORCEMENT_6";
