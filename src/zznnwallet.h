...
#ifndef ZNN_ZZNNWALLET_H
#define ZNN_ZZNNWALLET_H
...
public:
    CzZNNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZZNN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZZNN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
