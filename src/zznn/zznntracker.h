...
#ifndef ZNN_ZZNNTRACKER_H
#define ZNN_ZZNNTRACKER_H
...
public:
    CzZNNTracker(std::string strWalletFile);
    ~CzZNNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzZNNWallet* zZNNWallet = NULL);
