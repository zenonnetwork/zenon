                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzZNNPathCustom = GetArg("-zznnbackuppath", "");
    ...
    if(!strzZNNPathCustom.empty()) {
        ui->wallet_customzznnbackuppath->setText(QString::fromStdString(strzZNNPathCustom));
        ui->wallet_customzznnbackuppath_label->setVisible(true);
        ui->wallet_customzznnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzZNNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    ui->messagesWidget->document()->setDefaultStyleSheet(
        "table { }"
        "td.time { color: #9e9e9e; padding-top: 3px; } "
        "td.cmd-request { color: #6FF34D; } "
        "td.cmd-error { color: #F41954; } "
        ".secwarning { color: #F41954; }"
        "b { color: #6FF34D; } ");
    ...
    message(CMD_REPLY, (tr("Welcome to the Zenon RPC console.") + "<br>" +
                           tr("Use up and down arrows to navigate history, and <b>Ctrl-L</b> to clear screen.") + "<br>" +
                           tr("Type <b>help</b> for an overview of available commands.") + "<br>" + "<span class=\"secwarning\">" + "<br>" +
                           tr("WARNING: Beware of phishing attacks and scammers when you issue commands and take extra safety precautions when dealing with private keys. Do not use this console without fully understanding the ramifications of a command.") + "</span>"),
        true);
}
...
void RPCConsole::message(int category, const QString& message, bool html)
{
    ...
    QString out;
    out += "<table><tr><td class=\"time\" width=\"64\">" + timeString + "</td>";
