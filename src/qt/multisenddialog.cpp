                                                    ...
                                                    model(0)
{
    ...
    QString helpMsg1{"<p><b>MultiSend</b> allows you to automatically send up to 100% of your stake or masternode reward<br/>to a list of other <font color=\"#74f158\">ZENON</font> addresses after it matures.</p>"};
    QString helpMsg2{"<span>Add: Enter the percentage to give and a <font color=\"#74f158\">ZENON</font> address to add to the MultiSend vector."};
    QString helpMsg3{"Delete: Enter the <font color=\"#74f158\">ZENON</font> address to delete."};
    QString helpMsg4{"MultiSend: After configuring the addresses, click Activate.<span />"};
    QString tooltip(helpMsg1 + helpMsg2 + "<br/>" + helpMsg3 + "<br/>" + helpMsg4);
    ui->labelHelp->setToolTip(tooltip);
