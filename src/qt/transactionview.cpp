                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Zenon from zZenon"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zZenon"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zZenon));
