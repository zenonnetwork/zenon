...
//    typeWidget->addItem(tr("Mined"), TransactionFilterProxy::TYPE(TransactionRecord::Generated));
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZZNN));
    typeWidget->addItem(tr("Node Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
//    typeWidget->addItem(tr("Received ZNN from zZNN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
...
//    typeWidget->addItem(tr("Zerocoin Spend, Change in zZNN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zZnn));
...
void TransactionView::computeSum()
{
    ...
    if (amount < 0) strAmount = "<span style='color: #F41954;'>" + strAmount + "</span>";
