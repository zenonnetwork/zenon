...
void MasternodeList::updateMyNodeList(bool fForce)
{
    ...
    if (!masternodeConfig.read(strErr)) {
        LogPrintf("Error reading node configuration file: \n");
    }
    ...
    // Pillars
    int nCount = 0, ipv4 = 0, ipv6 = 0, onion = 0;
...
{
    // Display message box
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm all node start"),
...
void MasternodeList::on_startMissingButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this,
        tr("Confirm missing nodes start"),
        tr("Are you sure you want to start MISSING nodes?"),
        QMessageBox::Yes | QMessageBox::Cancel,
        QMessageBox::Cancel);
