...
//        frameBlocksLayout->addWidget(labelAutoMintIcon);
    ...
    if (curStyle == "QWindowsStyle" || curStyle == "QWindowsXPStyle") {
        ...
        progressBarDownloadUpdate->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00CCFF, stop: 1 #33CCFF); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&Zenon"), this);
...
//    sendCoinsAction->setStatusTip(tr("Send coins to a ZENON address"));
...
//    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zenon: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZNN"));
...
*/
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/masternodes"), tr("&Pillars"), this);
//        masternodeAction->setStatusTip(tr("Browse nodes"));
...
//    connect(privacyAction, SIGNAL(triggered()), this, SLOT(gotoPrivacyPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ZENON Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZENON Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options"), this);
    optionsAction->setStatusTip(tr("Modify configuration options for ZENON"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZENON addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZENON addresses"));
    bip38ToolAction = new QAction(QIcon(":/icons/key"), tr("&Encrypt Address"), this);
    bip38ToolAction->setToolTip(tr("Encrypt and decrypt private keys using a passphrase"));
    multiSendAction = new QAction(QIcon(":/icons/open_uri"), tr("&MultiSend"), this);
    ...
    openPeersAction = new QAction(QIcon(":/icons/history"), tr("&Peers list"), this);
    openPeersAction->setStatusTip(tr("Show peers info"));
    openRepairAction = new QAction(QIcon(":/icons/options"), tr("Wallet &Repair"), this);
    openRepairAction->setStatusTip(tr("Show wallet repair options"));
    openConfEditorAction = new QAction(QIcon(":/icons/edit"), tr("Open Wallet &Configuration File"), this);
    openConfEditorAction->setStatusTip(tr("Open configuration file"));
    openMNConfEditorAction = new QAction(QIcon(":/icons/edit"), tr("Open &Node Configuration File"), this);
    openMNConfEditorAction->setStatusTip(tr("Open Node configuration file"));
    ...
    multisigCreateAction = new QAction(QIcon(":/icons/editcopy"), tr("&Multisignature creation"), this);
    ...
    multisigSignAction = new QAction(QIcon(":/icons/edit"), tr("&Multisignature signing"), this);
    multisigSignAction->setStatusTip(tr("Sign with a multisignature address"));

    openAction = new QAction(QIcon(":/icons/open_uri"), tr("&Open URI"), this);
    openAction->setStatusTip(tr("Open a ZENON: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explore"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZENON Core help message to get a list with possible ZENON command-line options"));

    importPrivateKeyAction = new QAction(QIcon(":/icons/key"), tr("&Import private key"), this);
    importPrivateKeyAction->setToolTip(tr("Import a Zenon private key"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ZENON Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setStyleSheet("QPushButton { border:none;} QPushButton:hover { background-color:transparent; }");
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZENON network", "", count));
}
...
{
    QString strTitle = tr("ZENON Core"); // default title
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::UnlockedForAnonymizationOnly:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setIcon(QIcon(":/icons/lock_open").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
        labelEncryptionIcon->setToolTip(tr("Wallet is <b>encrypted</b> and currently <b>unlocked</b> and staking only"));
        encryptWalletAction->setChecked(true);
        changePassphraseAction->setEnabled(true);
