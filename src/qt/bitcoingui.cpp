...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    labelEncryptionIcon->setStyleSheet("QPushButton { border:none;} QPushButton:hover { background-color:transparent; }");
}
#endif // ENABLE_WALLET
