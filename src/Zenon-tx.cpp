...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zenon Core Zenon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Zenon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Zenon transaction") + "\n" +
                               "  Zenon-tx [options] -create [commands]   " + _("Create hex-encoded Zenon transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Zenon transaction
