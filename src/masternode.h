...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 ZNN, signature to prove
...
public:
    ...
    void swap(CMasternode& first, CMasternode& second) // nothrow
    {
        ...
        swap(first.isPillar, second.isPillar);
    }
