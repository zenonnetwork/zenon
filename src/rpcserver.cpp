...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zenon features */
        {"Zenon", "masternode", &masternode, true, true, false},
...
#ifdef ENABLE_WALLET
        {"Zenon", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Zenond, or the -server option to Zenon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
