...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zenon features */
        {"Zenon", "listmasternodes", &listmasternodes, true, true, false},
        {"Zenon", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Zenon", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Zenon", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"Zenon", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"Zenon", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"Zenon", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Zenon", "masternodedebug", &masternodedebug, true, true, false},
        {"Zenon", "startmasternode", &startmasternode, true, true, false},
        {"Zenon", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Zenon", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Zenon", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Zenon", "getmasternodestatus", &getmasternodestatus, true, true, false},
        ...
        {"Zenon", "preparebudget", &preparebudget, true, true, false},
        {"Zenon", "submitbudget", &submitbudget, true, true, false},
        {"Zenon", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Zenon", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Zenon", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Zenon", "checkbudgets", &checkbudgets, true, true, false},
...
{
    return "> Zenon-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35993/\n";
}
